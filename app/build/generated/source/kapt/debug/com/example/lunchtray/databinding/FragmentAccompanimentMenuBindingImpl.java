...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.model.MenuItem viewModelMenuItemsAndroidStringAccompaniment3 = null;
        java.util.Map<java.lang.String,com.example.lunchtray.model.MenuItem> viewModelMenuItems = null;
        com.example.lunchtray.model.MenuItem viewModelMenuItemsAndroidStringAccompaniment1 = null;
        ...
        com.example.lunchtray.model.MenuItem viewModelMenuItemsAndroidStringAccompaniment2 = null;
        ...
        boolean viewModelAccompanimentNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringAccompaniment1Name = false;
        java.lang.String subtotalAndroidStringSubtotalViewModelSubtotal = null;
        boolean viewModelAccompanimentNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringAccompaniment3Name = false;
        ...
        boolean viewModelAccompanimentNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringAccompaniment2Name = false;
        ...
        java.lang.String viewModelMenuItemsAndroidStringAccompaniment1Name = null;
        java.lang.String viewModelMenuItemsAndroidStringAccompaniment2Name = null;
        java.lang.String viewModelMenuItemsBerriesName = null;
        com.example.lunchtray.model.OrderViewModel viewModel = mViewModel;
        java.lang.String viewModelMenuItemsAndroidStringAccompaniment3Name = null;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x19L) != 0) {
                    ...
                    if (viewModelMenuItems != null) {
                        // read viewModel.menuItems[@android:string/accompaniment_3]
                        viewModelMenuItemsAndroidStringAccompaniment3 = viewModelMenuItems.get(pickles.getResources().getString(R.string.accompaniment_3));
                        // read viewModel.menuItems[@android:string/accompaniment_1]
                        viewModelMenuItemsAndroidStringAccompaniment1 = viewModelMenuItems.get(bread.getResources().getString(R.string.accompaniment_1));
                        // read viewModel.menuItems[@android:string/accompaniment_2]
                        viewModelMenuItemsAndroidStringAccompaniment2 = viewModelMenuItems.get(berries.getResources().getString(R.string.accompaniment_2));
                    }
                    ...
                    if (viewModelMenuItemsAndroidStringAccompaniment3 != null) {
                        // read viewModel.menuItems[@android:string/accompaniment_3].name
                        viewModelMenuItemsAndroidStringAccompaniment3Name = viewModelMenuItemsAndroidStringAccompaniment3.getName();
                    }
                    if (viewModelMenuItemsAndroidStringAccompaniment1 != null) {
                        // read viewModel.menuItems[@android:string/accompaniment_1].name
                        viewModelMenuItemsAndroidStringAccompaniment1Name = viewModelMenuItemsAndroidStringAccompaniment1.getName();
                    }
                    if (viewModelMenuItemsAndroidStringAccompaniment2 != null) {
                        // read viewModel.menuItems[@android:string/accompaniment_2].name
                        viewModelMenuItemsAndroidStringAccompaniment2Name = viewModelMenuItemsAndroidStringAccompaniment2.getName();
                    }


                    if (viewModelAccompanimentName != null) {
                        // read viewModel.accompaniment.getValue().name.equalsIgnoreCase(viewModel.menuItems[@android:string/accompaniment_3].name)
                        viewModelAccompanimentNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringAccompaniment3Name = viewModelAccompanimentName.equalsIgnoreCase(viewModelMenuItemsAndroidStringAccompaniment3Name);
                        // read viewModel.accompaniment.getValue().name.equalsIgnoreCase(viewModel.menuItems[@android:string/accompaniment_1].name)
                        viewModelAccompanimentNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringAccompaniment1Name = viewModelAccompanimentName.equalsIgnoreCase(viewModelMenuItemsAndroidStringAccompaniment1Name);
                        // read viewModel.accompaniment.getValue().name.equalsIgnoreCase(viewModel.menuItems[@android:string/accompaniment_2].name)
                        viewModelAccompanimentNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringAccompaniment2Name = viewModelAccompanimentName.equalsIgnoreCase(viewModelMenuItemsAndroidStringAccompaniment2Name);
                    }
        ...
        if ((dirtyFlags & 0x19L) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.berries, viewModelAccompanimentNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringAccompaniment2Name);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.bread, viewModelAccompanimentNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringAccompaniment1Name);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.pickles, viewModelAccompanimentNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringAccompaniment3Name);
        }
        ...
        switch(sourceId) {
            case 2: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setAccompaniment(berries.getResources().getString(R.string.accompaniment_2));
                }
                break;
            }
            case 5: {
            ...
            case 1: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setAccompaniment(bread.getResources().getString(R.string.accompaniment_1));
                }
                break;
            }
            case 4: {
            ...
            case 3: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setAccompaniment(pickles.getResources().getString(R.string.accompaniment_3));
                }
                break;
            }
        }
