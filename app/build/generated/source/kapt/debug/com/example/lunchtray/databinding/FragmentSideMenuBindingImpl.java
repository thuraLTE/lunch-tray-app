...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.model.MenuItem viewModelMenuItemsAndroidStringSide2 = null;
        boolean viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide3Name = false;
        ...
        com.example.lunchtray.model.MenuItem viewModelMenuItemsAndroidStringSide3 = null;
        ...
        com.example.lunchtray.model.MenuItem viewModelMenuItemsAndroidStringSide4 = null;
        ...
        boolean viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide4Name = false;
        java.lang.String subtotalAndroidStringSubtotalViewModelSubtotal = null;
        java.lang.String viewModelMenuItemsAndroidStringSide1Name = null;
        java.lang.String viewModelMenuItemsRiceDescription = null;
        boolean viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide1Name = false;
        java.lang.String viewModelMenuItemsRiceName = null;
        java.lang.String viewModelSubtotalGetValue = null;
        com.example.lunchtray.model.MenuItem viewModelMenuItemsAndroidStringSide1 = null;
        com.example.lunchtray.model.MenuItem viewModelMenuItemsRice = null;
        boolean viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide2Name = false;
        ...
        java.lang.String viewModelMenuItemsAndroidStringSide4Name = null;
        com.example.lunchtray.model.OrderViewModel viewModel = mViewModel;
        java.lang.String viewModelMenuItemsRiceGetFormattedPrice = null;
        java.lang.String viewModelMenuItemsAndroidStringSide2Name = null;
        java.lang.String viewModelMenuItemsAndroidStringSide3Name = null;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x1aL) != 0) {
                    ...
                    if (viewModelMenuItems != null) {
                        // read viewModel.menuItems[@android:string/side_2]
                        viewModelMenuItemsAndroidStringSide2 = viewModelMenuItems.get(soup.getResources().getString(R.string.side_2));
                        // read viewModel.menuItems[@android:string/side_3]
                        viewModelMenuItemsAndroidStringSide3 = viewModelMenuItems.get(potatoes.getResources().getString(R.string.side_3));
                        // read viewModel.menuItems[@android:string/side_4]
                        viewModelMenuItemsAndroidStringSide4 = viewModelMenuItems.get(rice.getResources().getString(R.string.side_4));
                        // read viewModel.menuItems[@android:string/side_1]
                        viewModelMenuItemsAndroidStringSide1 = viewModelMenuItems.get(salad.getResources().getString(R.string.side_1));
                    }
                    ...
                    if (viewModelMenuItemsAndroidStringSide2 != null) {
                        // read viewModel.menuItems[@android:string/side_2].name
                        viewModelMenuItemsAndroidStringSide2Name = viewModelMenuItemsAndroidStringSide2.getName();
                    }
                    if (viewModelMenuItemsAndroidStringSide3 != null) {
                        // read viewModel.menuItems[@android:string/side_3].name
                        viewModelMenuItemsAndroidStringSide3Name = viewModelMenuItemsAndroidStringSide3.getName();
                    }
                    if (viewModelMenuItemsAndroidStringSide4 != null) {
                        // read viewModel.menuItems[@android:string/side_4].name
                        viewModelMenuItemsAndroidStringSide4Name = viewModelMenuItemsAndroidStringSide4.getName();
                    }
                    if (viewModelMenuItemsAndroidStringSide1 != null) {
                        // read viewModel.menuItems[@android:string/side_1].name
                        viewModelMenuItemsAndroidStringSide1Name = viewModelMenuItemsAndroidStringSide1.getName();
                    }
                    ...
                    if (viewModelSideName != null) {
                        // read viewModel.side.getValue().name.equalsIgnoreCase(viewModel.menuItems[@android:string/side_3].name)
                        viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide3Name = viewModelSideName.equalsIgnoreCase(viewModelMenuItemsAndroidStringSide3Name);
                        // read viewModel.side.getValue().name.equalsIgnoreCase(viewModel.menuItems[@android:string/side_4].name)
                        viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide4Name = viewModelSideName.equalsIgnoreCase(viewModelMenuItemsAndroidStringSide4Name);
                        // read viewModel.side.getValue().name.equalsIgnoreCase(viewModel.menuItems[@android:string/side_1].name)
                        viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide1Name = viewModelSideName.equalsIgnoreCase(viewModelMenuItemsAndroidStringSide1Name);
                        // read viewModel.side.getValue().name.equalsIgnoreCase(viewModel.menuItems[@android:string/side_2].name)
                        viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide2Name = viewModelSideName.equalsIgnoreCase(viewModelMenuItemsAndroidStringSide2Name);
                    }
        ...
        if ((dirtyFlags & 0x1aL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.potatoes, viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide3Name);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.rice, viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide4Name);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.salad, viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide1Name);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.soup, viewModelSideNameEqualsIgnoreCaseViewModelMenuItemsAndroidStringSide2Name);
        }
        if ((dirtyFlags & 0x19L) != 0) {
            // api target 1
        ...
        switch(sourceId) {
            case 4: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setSide(rice.getResources().getString(R.string.side_4));
                }
                break;
            }
            case 5: {
            ...
            case 2: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setSide(soup.getResources().getString(R.string.side_2));
                }
                break;
            }
            case 6: {
            ...
            case 1: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setSide(salad.getResources().getString(R.string.side_1));
                }
                break;
            }
            case 3: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setSide(potatoes.getResources().getString(R.string.side_3));
                }
                break;
            }
        }
